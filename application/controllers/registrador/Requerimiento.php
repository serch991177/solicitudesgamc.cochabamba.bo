...
class Requerimiento extends CI_Controller
{
    ...
    public function editar()
    {
        ...
        $this->load->view('registrador/requerimiento/editar', $data);
    }
