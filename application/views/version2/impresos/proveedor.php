...
$pdf->Write(2, 'PROPUESTA', null, false, 'C', true);

$pdf->SetFont('helvetica', 'B', 7, '', true);

$cuerpo = $this->load->view('version2/impresos/body/tabla_proveedor', '', TRUE);

$pdf->writeHTML($cuerpo, true, false, true, false, 'C');

$pdf->SetFont('helvetica', 'B', 10, '', true);

$pdf->Write(2, 'DETALLE DE PROPUESTA', null, false, 'C', true);

$pdf->SetFont('helvetica', 'B', 7, '', true);

$cuerpo = $this->load->view('version2/impresos/body/tabla_caracteristicas', '', TRUE);

$pdf->writeHTML($cuerpo, true, false, true, false, '');

$pdf->Output('propuesta.pdf', 'I');
