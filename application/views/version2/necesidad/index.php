      ...
      <div class="box no-shadow">
         ...
         <div class="box-body">
            <div class="row">
               ...
               <div class="columns large-2 medium-2 small-2 large-offset-1">
                  <button class="large button expanded palette-Celeste bg" onclick="notificarNovedades()" style="display: <?= $button; ?>;" >
                     <i class="las la-bullhorn la-2x"></i><span> Notificar</span>
                  </button>
               </div>
               <div class="columns large-2 medium-2 small-2 large">
                  <a class="large button expanded palette-Celeste bg" href="agregar-item">
...
<div class="large reveal" id="modalRegistrar" data-reveal data-options="closeOnClick:false; closeOnEsc:false;">
   ...
   <?= form_open_multipart('agregar-item', 'data-abide no-validate'); ?>
   <div class="large-12">
      <div class="row">
...
<?php $this->load->view('version2/necesidad/js/index') ?>
