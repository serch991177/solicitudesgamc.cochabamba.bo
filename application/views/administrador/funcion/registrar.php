               ...
               <div class="row">
                  <div class="large-4 columns">
                     ...
                     <div class="input-group">
                        ...
                        <?=form_dropdown('es_menu', $si_no, set_value('es_menu'), ['class'=>'input-group-field', 'required'=>'required','id'=>'es_menu']); ?>
                     </div>
                  ...
                  <div class="large-4 columns">
                     ...
                     <div class="input-group">
                        <span class="input-group-label"><i class="las la-sitemap"></i></span>
                        <?=form_dropdown('es_submenu', $si_no, set_value('es_submenu'), ['class'=>'input-group-field', 'required'=>'required', 'id'=>'es_submenu']); ?>
                     </div>
                  ...
                  <div class="large-4 columns">
                     ...
                     <div class="input-group">
                        <span class="input-group-label"><i class="las la-sitemap"></i></span>
                        <?=form_dropdown('es_sub_submenu', $si_no, set_value('es_sub_submenu'), ['class'=>'input-group-field', 'required'=>'required', 'id'=>'es_sub_submenu']); ?>
                     </div>
