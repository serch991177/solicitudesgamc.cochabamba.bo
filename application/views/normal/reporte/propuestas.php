...
$pdf->SetFont('helvetica', 'B', 8, '', true);
$pdf->Cell(75, 8, 'TIEMPO DE ENTREGA (DÍAS CALENDARIO):', 1, 0, 'C', 0, '', 0);
$pdf->SetFont('helvetica', '', 8, '', true);
$pdf->Cell(105, 8, $item->tiempo_entrega, 1, 1, 'C', 0, '', 0);

$pdf->SetFont('helvetica', 'B', 8, '', true);
$pdf->Cell(75, 8, 'VALIDEZ DE LA PROPUESTA (DÍAS CALENDARIO):', 1, 0, 'C', 0, '', 0);
$pdf->SetFont('helvetica', '', 8, '', true);
$pdf->Cell(105, 8, $item->validez, 1, 1, 'C', 0, '', 0);
...
$pdf->SetFont('helvetica', 'B', 11, '', true);
$pdf->Cell(0, 8, 'PROPUESTAS RECEPCIONADAS', 0, 1, 'C', 0, '', 0);
$pdf->ln(2);



$pdf->SetFont('helvetica', 'B', 7, '', true);
$pdf->Cell(10, 8, 'No', 1, 0, 'C', 0, '', 0);
$pdf->Cell(80, 8, 'Razón Social/Nombre Empresa/Persona', 1, 0, 'C', 0, '', 0);
$pdf->Cell(20, 8, 'N° de Contacto', 1, 0, 'C', 0, '', 0);
$pdf->Cell(30, 8, 'Precio Propuesto', 1, 0, 'C', 0, '', 0);
$pdf->Cell(40, 8, 'Fecha de Registro de Propuesta', 1, 1, 'C', 0, '', 0);
...
/*if ($item->fecha_limite >= $date) {
    ...
    foreach ($propuestas as $value) {
        $pdf->Cell(10, 8, $value->row, 1, 0, 'C', 0, '', 0);
        $pdf->Cell(90, 8, $value->nombre_completo, 1, 0, 'C', 0, '', 0);
        $pdf->Cell(40, 8, $precio, 1, 0, 'C', 0, '', 0);
        $pdf->Cell(40, 8, $value->fecha_format, 1, 1, 'C', 0, '', 0);
    }
} else {*/
    
    foreach ($propuestas as $value) {
        $precio = $value->precio_propuesto;
        $pdf->Cell(10, 8, $value->row, 1, 0, 'C', 0, '', 0);
        $pdf->Cell(80, 8, $value->nombre_completo, 1, 0, 'C', 0, '', 0);
        $pdf->Cell(20, 8, $value->celular, 1, 0, 'C', 0, '', 0);
        $pdf->Cell(30, 8, number_format($precio,0,',','.'), 1, 0, 'C', 0, '', 0);
        $pdf->Cell(40, 8, $value->fecha_format, 1, 1, 'C', 0, '', 0);
    }
//}
