            ...
            <div class="box-body">
                <div class="row">
                    <div class="large-12 columns medium-12 small-12">
                        <?= form_open_multipart('modificar-item', 'data-abide no-validate'); ?>
                        <div class="row">
                        ...
                        <div class="row align-right">
                            <div class="column small-6">
                                <a href="ver-items" data-close class="button expanded bg palette-Red">Volver</a>
                            </div>
                            <div class="column small-6">
...
<?php $this->load->view('normal/item/js/editar') ?>
