         ...
         <div class="box-body">
            <div class="row">
               ...
               <div class="columns large-2 medium-2 small-2 large-offset-1">
                  <button class="large button expanded palette-Celeste bg" onclick="notificarNovedades()" disabled>
...
<div class="large reveal" id="modalRegistrar" data-reveal data-options="closeOnClick:false; closeOnEsc:false;">
   ...
   <?= form_open_multipart('registro-item', 'data-abide no-validate'); ?>
   <div class="large-12">
      <div class="row">
...
<?php $this->load->view('normal/item/js/index') ?>
